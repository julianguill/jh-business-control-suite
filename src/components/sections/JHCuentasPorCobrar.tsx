...
const JHCuentasPorCobrar = () => {
  ...
  const crearCuenta = () => {
    if (!nuevaCuenta.cliente || !nuevaCuenta.concepto || !nuevaCuenta.monto || !nuevaCuenta.fechaVencimiento) {
      toast({
        title: "Error",
    ...
    setNuevaCuenta({ cliente: '', concepto: '', monto: '', fechaVencimiento: '', descripcion: '' });
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Cuentas por Cobrar</h1>
          <p className="text-lg text-gray-600">Gestiona los montos pendientes de cobro</p>
        </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Listado de Cuentas por Cobrar ({cuentasFiltradas.length})</CardTitle>
        </CardHeader>
        <CardContent>
